<?php
      ...
      $compteManager = new CompteManager($pdo);
            ...
            <tr><td><?php echo $eve->getTitre();?>
						...
						</td><td><a href="index.php?page=11&id=<?php echo $eve->getIdEve(); ?>"><img class="modifier" src="img/modifier.png" alt="Acceder aux details de l'evenement !" title="modifIcon"/></a></td>
